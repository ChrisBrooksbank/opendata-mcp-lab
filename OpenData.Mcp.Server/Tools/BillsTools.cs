...
namespace OpenData.Mcp.Server.Tools
{
    ...
    public class BillsTools(IHttpClientFactory httpClientFactory, ILogger<BillsTools> logger, IMemoryCache cache) : BaseTools(httpClientFactory, logger, cache)
    {
        ...
        public async Task<McpToolResponse> SearchBillsAsync([Description("Search term for bill titles or content (e.g. 'environment', 'health', 'finance')")] string searchTerm, [Description("Optional: member ID to filter bills sponsored by specific member")] int? memberId = null)
        {
        ...
        public async Task<McpToolResponse> BillTypesAsync()
        {
        ...
        public async Task<McpToolResponse> BillStagesAsync()
        {
        ...
        public async Task<McpToolResponse> GetBillByIdAsync([Description("Unique bill ID number")] int billId)
        {
        ...
        public async Task<McpToolResponse> GetBillStagesAsync([Description("Bill ID to get stages for")] int billId, [Description("Optional: number of records to skip (for pagination)")] int? skip = null, [Description("Optional: number of records to return")] int? take = null)
        {
        ...
        public async Task<McpToolResponse> GetBillStageDetailsAsync([Description("Bill ID")] int billId, [Description("Bill stage ID to get details for")] int billStageId)
        {
        ...
        public async Task<McpToolResponse> GetAmendmentByIdAsync([Description("Bill ID")] int billId, [Description("Bill stage ID")] int billStageId, [Description("Amendment ID to get details for")] int amendmentId)
        {
        ...
        public async Task<McpToolResponse> GetPingPongItemByIdAsync([Description("Bill ID")] int billId, [Description("Bill stage ID")] int billStageId, [Description("Ping pong item ID to get details for")] int pingPongItemId)
        {
        ...
        public async Task<McpToolResponse> GetBillPublicationsAsync([Description("Bill ID to get publications for")] int billId)
        {
        ...
        public async Task<McpToolResponse> GetBillStagePublicationsAsync([Description("Bill ID")] int billId, [Description("Stage ID to get publications for")] int stageId)
        {
        ...
        public async Task<McpToolResponse> GetPublicationDocumentAsync([Description("Publication ID")] int publicationId, [Description("Document ID to get details for")] int documentId)
        {
        ...
        public async Task<McpToolResponse> GetBillNewsArticlesAsync([Description("Bill ID to get news articles for")] int billId, [Description("Optional: number of records to skip (for pagination)")] int? skip = null, [Description("Optional: number of records to return")] int? take = null)
        {
        ...
        public async Task<McpToolResponse> GetAllBillsRssAsync()
        {
        ...
        public async Task<McpToolResponse> GetPublicBillsRssAsync()
        {
        ...
        public async Task<McpToolResponse> GetPrivateBillsRssAsync()
        {
        ...
        public async Task<McpToolResponse> GetBillRssAsync([Description("Bill ID to get RSS feed for")] int billId)
        {
        ...
        public async Task<McpToolResponse> GetPublicationTypesAsync([Description("Optional: number of records to skip (for pagination)")] int? skip = null, [Description("Optional: number of records to return")] int? take = null)
        {
