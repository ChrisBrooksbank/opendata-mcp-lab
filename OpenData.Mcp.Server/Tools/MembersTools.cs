...
namespace OpenData.Mcp.Server
{
    ...
    public class MembersTools(IHttpClientFactory httpClientFactory, ILogger<MembersTools> logger, IMemoryCache cache) : BaseTools(httpClientFactory, logger, cache)
    {
        ...
        public async Task<McpToolResponse> GetAnsweringBodiesAsync()
        {
        ...
        public async Task<McpToolResponse> GetMemberByIdAsync([Description("Parliament member ID | Required: get from member search first | Example: 1423")] int id)
        {
        ...
        public async Task<McpToolResponse> EdmsForMemberIdAsync([Description("Parliament member ID to get EDMs for")] int memberid)
        {
        ...
        public async Task<McpToolResponse> PartiesListByHouseAsync([Description("House number: 1 for Commons, 2 for Lords")] int house)
        {
        ...
        public async Task<McpToolResponse> GetDepartmentsAsync()
        {
        ...
        public async Task<McpToolResponse> GetContributionsAsync([Description("Parliament member ID to get contribution summary for")] int memberid)
        {
        ...
        public async Task<McpToolResponse> GetConstituenciesAsync([Description("Number of constituencies to skip (for pagination)")] int? skip = null, [Description("Number of constituencies to return (default 20, max 100)")] int? take = null)
        {
        ...
        public async Task<McpToolResponse> GetElectionResultsForConstituencyAsync([Description("Unique constituency ID number")] int constituencyid)
        {
        ...
        public async Task<McpToolResponse> GetLordsInterestsStaffAsync([Description("Search term for staff names or interests (default 'richard')")] string searchterm = "richard")
        {
        ...
        public async Task<McpToolResponse> GetMembersBiography([Description("Parliament member ID | Required: get from member search first | Returns comprehensive biographical information")] int memberId)
        {
        ...
        public async Task<McpToolResponse> GetMembersContact([Description("Parliament member ID | Required: get from member search first | Returns official contact details")] int memberId)
        {
        ...
        public async Task<McpToolResponse> GetMemberExperienceAsync([Description("Parliament member ID to get professional experience for")] int memberId)
        {
        ...
        public async Task<McpToolResponse> GetMemberFocusAsync([Description("Parliament member ID to get policy focus areas for")] int memberId)
        {
        ...
        public async Task<McpToolResponse> GetMemberRegisteredInterestsAsync([Description("Parliament member ID to get registered interests for")] int memberId, [Description("Optional: house number (1=Commons, 2=Lords)")] int? house = null)
        {
        ...
        public async Task<McpToolResponse> GetMemberStaffAsync([Description("Parliament member ID to get staff details for")] int memberId)
        {
        ...
        public async Task<McpToolResponse> GetMemberSynopsisAsync([Description("Parliament member ID to get synopsis for")] int memberId)
        {
        ...
        public async Task<McpToolResponse> GetMemberVotingAsync([Description("Parliament member ID to get voting record for")] int memberId, [Description("House number (1=Commons, 2=Lords)")] int house, [Description("Optional: page number for pagination")] int? page = null)
        {
        ...
        public async Task<McpToolResponse> GetMemberWrittenQuestionsAsync([Description("Parliament member ID to get written questions for")] int memberId, [Description("Optional: page number for pagination")] int? page = null)
        {
        ...
        public async Task<McpToolResponse> GetMembersHistoryAsync([Description("Array of Parliament member IDs to get history for")] int[] memberIds)
        {
        ...
        public async Task<McpToolResponse> GetMemberLatestElectionResultAsync([Description("Parliament member ID to get latest election result for")] int memberId)
        {
        ...
        public async Task<McpToolResponse> GetMemberPortraitUrlAsync([Description("Parliament member ID to get portrait URL for")] int memberId)
        {
        ...
        public async Task<McpToolResponse> GetMemberThumbnailUrlAsync([Description("Parliament member ID to get thumbnail URL for")] int memberId)
        {
